...
public class GLPaddle {
     ...
     */
    public GLPaddle(Paddle paddle) {
    	this.paddle = paddle;
    	
        // initialize vertex byte buffer for shape coordinates
        ByteBuffer coordinatesBuffer = ByteBuffer.allocateDirect(squareCoords.length * 4);
        coordinatesBuffer.order(ByteOrder.nativeOrder());
        vertexBuffer = coordinatesBuffer.asFloatBuffer();
